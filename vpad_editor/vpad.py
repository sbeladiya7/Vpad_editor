...
# ----size box
size_var = tk.IntVar()
size_box = ttk.Combobox(tool_bar, width = 17, textvariable = size_var, state = 'readonly')
...
def find_func(event=None):
    ...
    # entry
    find_entry = ttk.Entry(find_frame, width = 27)
    replace_entry = ttk.Entry(find_frame, width = 27)
...
count = 0
for i in color_dict:
    color_theme.add_radiobutton(label = i, image = color_icon[count], compound = tk.LEFT, variable = theme_choice, command = change_theme)
    count += 1
